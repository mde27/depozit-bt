...
const envPath = process.env.DATABASE_PATH || process.env.DATABASE;
const dbPath = envPath
  ? path.isAbsolute(envPath)
    ? envPath
    : path.resolve(process.cwd(), envPath)
  : path.join(defaultDataDir, 'depozit.db');
...
export const SCAN_STAGES = ['SEND', 'DELIVER', 'RETURN_OUT', 'RECEIVE_BACK'] as const;
